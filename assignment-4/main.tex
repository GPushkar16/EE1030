...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.4]{figs/plot_triangle_1.png}
	\label{Fig}
\end{figure}
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.4]{figs/plot_triangle_2.png}
	\label{Fig}
\end{figure}
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.4]{figs/plot_triangle_3.png}
	\label{Fig}
\end{figure}
\end{document}
