...
\begin{enumerate}
    ...
    \item In the two-port network shown, the $h_{11}$ parameter \brak{ where, $h_{11}=\frac{V_1}{I_1}$, when $V_2=0$} in ohms is \rule{2.5cm}{0.4pt}(up to 2 decimal places).
    \input{circuits/circuit3.tex}
