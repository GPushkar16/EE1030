...
\draw (3,16) to[D] (3,15);
\draw (3,15) to[D] (4,15);
\draw (4,16) to[short] (4,14);
\draw (3,15) to[short] (3,14);
\draw (3,14) to[C] (3.5,14);
\draw (3.5,14) to[L ] (4,14);
\draw (4,16) to[short] (4.75,16);
\draw (3,16) to[short] (1.5,16);
\draw (4.75,16) to[short] (5.75,16);
\draw (5.75,16) to[short] (5.75,15);
\draw  (5.75,15) rectangle (5.5,14);
\draw (5.5,14) to[short] (5.5,13.25);
\draw (1.5,13.25) to[short] (5.5,13.25);
\draw (4.75,13.25) to[D] (4.75,16);
\draw (1.5,16) to[battery2] (1.5,13.25);
\node [font=\small] at (1,14.75) {230 V};
\node [font=\normalsize] at (3.5,16.25) {ThM};
\node [font=\normalsize] at (3,13.75) {10 mF};
\node [font=\normalsize] at (3.75,14.5) {25.28 mH};
\end{circuitikz}
}%
