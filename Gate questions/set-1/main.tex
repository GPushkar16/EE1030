...
\draw (1,15.75) to[opening switch] (2.5,15.75);
\draw (2.5,15.75) to[R] (3.5,15.75);
\draw (3.5,15.75) to[L ] (3.5,13.75);
\draw (3.5,13.75) to[short] (1,13.75);
\draw (1,15.75) to[battery1] (1,13.75);
\draw [short] (4.25,16.25) -- (4.25,13);
\draw [short] (4.5,16.25) -- (4.5,13);
\draw (5.25,16) to[L ] (5.25,15);
\draw (5.25,16) to[R] (7,16);
\draw (7,16) to[short] (7,15);
\draw (5.25,15) to[short] (7,15);
\draw (5.25,14.25) to[C] (7,14.25);
\draw (5.25,14.25) to[L ] (5.25,13.25);
\draw (5.25,13.25) to[short] (7,13.25);
\draw (7,14.25) to[short] (7,13.25);
\node [font=\small] at (0.5,15) {$25V$};
\node [font=\small] at (1.75,16.25) {SW};
\node [font=\small] at (4.5,16.5) {$T_1$};
\draw [->, >=Stealth] (5.5,16.75) -- (7,16.75);
\node [font=\small] at (5.75,17) {$IR$};
\node [font=\small] at (6.5,16.25) {$R$};
\node [font=\small] at (6.5,14.5) {$C$};
\end{circuitikz}
}%
