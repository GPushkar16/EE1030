...
\node [font=\LARGE] at (0.25,15.25) {25 V};
...
\node [font=\LARGE] at (2,16.75) {SW};
\node [font=\LARGE] at (2,16.75) {};
\node [font=\LARGE] at (4.5,16.75) {T1};
...
\node [font=\LARGE] at (6.5,16.75) {R};
\draw [->, >=Stealth] (5.25,17.25) -- (6.75,17.25);
\node [font=\LARGE] at (6,17.25) {};
\node [font=\LARGE] at (6,17.75) {IR};
...
\node [font=\large] at (5.5,15.25) {IC 555};
...
\draw (7.75,14.75) to[european resistor] (7.75,12.5);
...
\node [font=\normalsize] at (2.5,14.25) {};
\node [font=\normalsize] at (2.5,14.25) {L};
\node [font=\normalsize] at (3.25,15) {10
emps};
\node [font=\normalsize] at (0.75,15.5) {R1 10 ohm};
\node [font=\normalsize] at (1.75,14.5) {SW1};
\node [font=\normalsize] at (2.5,16.25) {SW2};
\node [font=\normalsize] at (4,16.75) {R2 10 ohm};
\node [font=\normalsize] at (4.25,14.75) {C};
\node [font=\normalsize] at (5.5,14.75) {10 V};
\end{circuitikz}
}%
...
\begin{circuitz}
\tikzstyle{every node}=[font=\normalsize]
\draw (1.5,16.75) to[R] (3.5,16.75);
\draw (1.5,16.75) to[sinusoidal voltage source, sources/symbol/rotate=auto] (1.5,15.25);
\draw (1.5,15.25) to[C] (3.5,15.25);
\draw (3.5,16.75) to[L ] (3.5,15.25);
\node [font=\normalsize] at (4,15.75) {L};
\node [font=\normalsize] at (2.5,14.75) {C};
\node [font=\normalsize] at (1,16.25) {w};
\node [font=\normalsize] at (3,17.25) {R};
\end{circuitikz}
...
\begin{circuitikz}
\tikzstyle{every node}=[font=\small]
\draw [short] (1,15.25) -- (1,16.25);
\draw [short] (1,16.25) -- (1.5,16.25);
\draw [short] (0.5,15.25) -- (1,15.25);
\node [font=\small] at (0.5,15.5) {$0$};
\node [font=\small] at (1.25,16.5) {$1$};
\draw [->, >=Stealth] (1.5,16) -- (2,16);
\draw  (2.5,16) ellipse (0.5cm and 0.5cm);
\node [font=\small] at (2.5,16) {$\epsilon$};
\draw [->, >=Stealth] (3,16) -- (3.75,16);
\draw (3.25,16) to[short] (3.25,17.5);
\draw [->, >=Stealth] (3.25,17.5) -- (4.25,17.5);
\draw  (4.25,18) rectangle (5,17);
\node [font=\small] at (4.5,17.5) {$\frac{k_i}{s}$};
\draw  (3.5,16.5) rectangle (4.5,15.5);
\node [font=\small] at (4,16.25) {$k_p$};
\draw [->, >=Stealth] (4.5,16) -- (5.25,16);
\draw [->, >=Stealth] (5,17) -- (5.5,16.25);
\node [font=\small] at (5.5,15.75) {$\epsilon$};
\draw [->, >=Stealth] (6,15.75) -- (6.5,15.75);
\draw  (7,16) rectangle (7.25,16);
\draw  (5.5,15.75) circle (0.5cm);
\draw  (6.5,16.25) rectangle (8,15.25);
\node [font=\small] at (7,15.75) {$\frac{w^2}{s^2+2\epsilon w+w^2}$};
\draw [->, >=Stealth] (8,16.25) -- (10.25,16.25);
\draw (9,16.25) to[short] (9,13.75);
\draw (2.75,14) to[short] (9,14);
\draw [->, >=Stealth] (2.75,14) -- (2.5,15.5);
\end{circuitikz}
}%
